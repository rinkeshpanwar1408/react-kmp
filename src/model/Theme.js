...
export const normal_font = "1.6rem";
export const small_font = "1.4rem";
...
//For danger
export const light_danger_primary = "#ff4d4f";
export const light_danger_bg_secondary = "#ff7875";

export const dark_danger_primary = "#a61d24";
